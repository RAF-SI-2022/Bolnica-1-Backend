package raf.bolnica1.infirmary.util.dataGenerators.primitives.util;
...
public class DevPatientGetter {
    ...
    @Autowired
    public DevPatientGetter(DevJwtTokenGetter devJwtTokenGetter, RestTemplate patientRestTemplate,
                            ExtractPageContentFromPageJson extractPageContentFromPageJson){
        this.devJwtTokenGetter = devJwtTokenGetter;
    ...
    public static DevPatientGetter getInstance(){
        DevPatientGetter ret= new DevPatientGetter(DevJwtTokenGetter.getInstance(), RestServiceClientConfig.patientRestTemplate()
