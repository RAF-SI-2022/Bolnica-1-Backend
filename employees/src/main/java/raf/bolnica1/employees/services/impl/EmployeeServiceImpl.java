...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    private void addEmployeePermission(Employee newEmployee, List<String> permissions) {
        for(String permission : permissions){
            ...
            Privilege privilege = privilegeRepository.findByprivilegeShort(PrivilegeShort.valueOf(permission)).orElseThrow(() -> new RuntimeException(String.format("Permission %s is not supported", permission)));
