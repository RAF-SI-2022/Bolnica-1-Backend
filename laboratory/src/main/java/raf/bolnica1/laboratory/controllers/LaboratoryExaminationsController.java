...
public class LaboratoryExaminationsController {
    ...
    public ResponseEntity<ScheduledLabExaminationDto> createScheduledExamination(@RequestParam("lbp")String lbp, @RequestParam("date")Date scheduledDate,@RequestParam("note")String note,HttpServletRequest request) {
