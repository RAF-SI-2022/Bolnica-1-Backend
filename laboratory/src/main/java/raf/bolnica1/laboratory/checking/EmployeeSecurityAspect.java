package raf.bolnica1.laboratory.checking;
...
import raf.bolnica1.laboratory.checking.jwtService.TokenService;
import raf.bolnica1.laboratory.dto.permission.PermissionsCheckDto;
...
public class EmployeeSecurityAspect {
    ...
    @Around("@annotation(raf.bolnica1.laboratory.checking.CheckPermission)")
