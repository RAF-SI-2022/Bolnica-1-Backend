package raf.bolnica1.laboratory.util.dataGenerators.primitives.util.patient;

import lombok.Getter;
import lombok.NoArgsConstructor;
import lombok.Setter;
import raf.bolnica1.laboratory.util.dataGenerators.primitives.util.patient.constants.*;
